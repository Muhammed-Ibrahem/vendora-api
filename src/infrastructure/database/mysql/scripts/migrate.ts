...
import { registerMySQLDatabase } from "~/container/tsyringe/MySQLDIContainer";
import { MySQLConnection } from "~/database/mysql/client/MySQLClient";

registerMySQLDatabase(container);

const MIGRATIONS_DIR = join(__dirname, "..", "migrations");

const mysqlClient = container.resolve(MySQLConnection).getPool();
